...
class TestStorage(unittest.TestCase):
    def test_storage(self):
        sdk = ThirdwebSdk(
            SdkOptions(private_key=os.environ["PKEY"]),
        ...
        with open(file="tests/test.png", mode="rb") as f:
            ...
            self.assertTrue(
                module.image.startswith("ipfs://"),
                "Image files are expected to be uploaded when set in the image property",
            )
