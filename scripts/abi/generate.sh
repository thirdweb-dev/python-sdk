...
mkdir -p thirdweb/abi/token_erc20/bytecode && echo -n "TOKEN_ERC20_BYTECODE = " > thirdweb/abi/token_erc20/bytecode/__init__.py
...
mkdir -p thirdweb/abi/token_erc721/bytecode && echo -n "TOKEN_ERC721_BYTECODE = " > thirdweb/abi/token_erc721/bytecode/__init__.py
...
mkdir -p thirdweb/abi/token_erc1155/bytecode && echo -n "TOKEN_ERC1155_BYTECODE = " > thirdweb/abi/token_erc1155/bytecode/__init__.py
