...
from thirdweb.abi.token_erc1155.bytecode import TOKEN_ERC1155_BYTECODE
from thirdweb.abi.token_erc20.bytecode import TOKEN_ERC20_BYTECODE
from thirdweb.abi.token_erc721.bytecode import TOKEN_ERC721_BYTECODE
