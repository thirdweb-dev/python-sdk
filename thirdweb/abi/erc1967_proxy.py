"""Generated wrapper for ERC1967Proxy Solidity contract."""
...
# constructor for ERC1967Proxy below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        ERC1967ProxyValidator,
    )
except ImportError:

    class ERC1967ProxyValidator(Validator):  # type: ignore
...
class ERC1967Proxy:
    """Wrapper class for ERC1967Proxy Solidity contract.
    ...
    def __init__(
        ...
        validator: ERC1967ProxyValidator = None,
    ):
        ...
        if not validator:
            validator = ERC1967ProxyValidator(
