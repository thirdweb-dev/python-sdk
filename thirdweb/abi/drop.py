"""Generated wrapper for Drop Solidity contract."""
...
try:
    ...
    class DropValidator(Validator):  # type: ignore
...
class Drop:
    """Wrapper class for Drop Solidity contract.
    ...
    def __init__(
        ...
        if not validator:
            validator = DropValidator(web3_or_provider, contract_address)
        ...
        functions = self._web3_eth.contract(
            address=to_checksum_address(contract_address), abi=Drop.abi()
        ).functions
