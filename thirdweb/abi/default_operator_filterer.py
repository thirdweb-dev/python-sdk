"""Generated wrapper for DefaultOperatorFilterer Solidity contract."""
...
# constructor for DefaultOperatorFilterer below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        DefaultOperatorFiltererValidator,
    )
except ImportError:

    class DefaultOperatorFiltererValidator(Validator):  # type: ignore
...
class DefaultOperatorFilterer:
    """Wrapper class for DefaultOperatorFilterer Solidity contract."""
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: DefaultOperatorFiltererValidator = None,
    ):
        ...
        if not validator:
            validator = DefaultOperatorFiltererValidator(
        ...
        functions = self._web3_eth.contract(
            ...
            abi=DefaultOperatorFilterer.abi(),
        ).functions
