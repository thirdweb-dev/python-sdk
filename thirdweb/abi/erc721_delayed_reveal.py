"""Generated wrapper for ERC721DelayedReveal Solidity contract."""
...
# constructor for ERC721DelayedReveal below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        ERC721DelayedRevealValidator,
    )
except ImportError:

    class ERC721DelayedRevealValidator(Validator):  # type: ignore
...
class ClaimMethod(ContractMethod):  # pylint: disable=invalid-name
    ...
    def validate_and_normalize_inputs(self, receiver: str, quantity: int):
    ...
    def call(
        ...
        :returns: the return value of the underlying method.
        """
        (receiver, quantity) = self.validate_and_normalize_inputs(
            receiver, quantity
        )
        tx_params = super().normalize_tx_params(tx_params)
        self._underlying_method(receiver, quantity).call(tx_params.as_dict())
    ...
    def send_transaction(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(receiver, quantity).transact(
            tx_params.as_dict()
        )
    ...
    def build_transaction(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(receiver, quantity).buildTransaction(
            tx_params.as_dict()
        )
    ...
    def estimate_gas(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(receiver, quantity).estimateGas(
            tx_params.as_dict()
        )
...
class VerifyClaimMethod(ContractMethod):  # pylint: disable=invalid-name
    ...
    def validate_and_normalize_inputs(self, claimer: str, quantity: int):
        ...
        # safeguard against fractional inputs
        quantity = int(quantity)
        return (claimer, quantity)

    def call(
        self, claimer: str, quantity: int, tx_params: Optional[TxParams] = None
    ) -> None:
        """Execute underlying contract method via eth_call.
        ...
        :returns: the return value of the underlying method.
        """
        (claimer, quantity) = self.validate_and_normalize_inputs(
            claimer, quantity
        )
        tx_params = super().normalize_tx_params(tx_params)
        self._underlying_method(claimer, quantity).call(tx_params.as_dict())
    ...
    def send_transaction(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(claimer, quantity).transact(
            tx_params.as_dict()
        )
    ...
    def build_transaction(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(claimer, quantity).buildTransaction(
            tx_params.as_dict()
        )
    ...
    def estimate_gas(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(claimer, quantity).estimateGas(
            tx_params.as_dict()
        )


# pylint: disable=too-many-public-methods,too-many-instance-attributes
class ERC721DelayedReveal:
    """Wrapper class for ERC721DelayedReveal Solidity contract.
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: ERC721DelayedRevealValidator = None,
    ):
        ...
        if not validator:
            validator = ERC721DelayedRevealValidator(
