"""Generated wrapper for SignatureMintERC721Upgradeable Solidity contract."""
...
# constructor for SignatureMintERC721Upgradeable below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        SignatureMintERC721UpgradeableValidator,
    )
except ImportError:

    class SignatureMintERC721UpgradeableValidator(Validator):  # type: ignore
...
class SignatureMintERC721Upgradeable:
    """Wrapper class for SignatureMintERC721Upgradeable Solidity contract.
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: SignatureMintERC721UpgradeableValidator = None,
    ):
        ...
        if not validator:
            validator = SignatureMintERC721UpgradeableValidator(
        ...
        functions = self._web3_eth.contract(
            ...
            abi=SignatureMintERC721Upgradeable.abi(),
        ).functions
