"""Generated wrapper for IAirdropERC1155 Solidity contract."""
...
# constructor for IAirdropERC1155 below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        IAirdropERC1155Validator,
    )
except ImportError:

    class IAirdropERC1155Validator(Validator):  # type: ignore
...
class IAirdropERC1155:
    """Wrapper class for IAirdropERC1155 Solidity contract."""
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: IAirdropERC1155Validator = None,
    ):
        ...
        if not validator:
            validator = IAirdropERC1155Validator(
