"""Generated wrapper for ERC721SignatureMint Solidity contract."""
...
# constructor for ERC721SignatureMint below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        ERC721SignatureMintValidator,
    )
except ImportError:

    class ERC721SignatureMintValidator(Validator):  # type: ignore
...
class ERC721SignatureMint:
    """Wrapper class for ERC721SignatureMint Solidity contract.
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: ERC721SignatureMintValidator = None,
    ):
        ...
        if not validator:
            validator = ERC721SignatureMintValidator(
