"""Generated wrapper for DropSinglePhase_V1 Solidity contract."""
...
# constructor for DropSinglePhase_V1 below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        DropSinglePhase_V1Validator,
    )
except ImportError:

    class DropSinglePhase_V1Validator(Validator):  # type: ignore
...
class VerifyClaimMerkleProofMethod(
    ...
    def validate_and_normalize_inputs(
        ...
        return (claimer, quantity, allowlist_proof)
    ...
    def call(
        ...
        (
            ...
            claimer, quantity, allowlist_proof
        )
        tx_params = super().normalize_tx_params(tx_params)
...
class DropSinglePhase_V1:
    """Wrapper class for DropSinglePhase_V1 Solidity contract.
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: DropSinglePhase_V1Validator = None,
    ):
        ...
        if not validator:
            validator = DropSinglePhase_V1Validator(
