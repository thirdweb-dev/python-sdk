"""Generated wrapper for Staking20 Solidity contract."""
...
# constructor for Staking20 below.
try:
    ...
    class Staking20Validator(Validator):  # type: ignore
...
class Staking20:
    """Wrapper class for Staking20 Solidity contract."""
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: Staking20Validator = None,
    ):
        ...
        if not validator:
            validator = Staking20Validator(web3_or_provider, contract_address)
        ...
        functions = self._web3_eth.contract(
            address=to_checksum_address(contract_address), abi=Staking20.abi()
        ).functions
