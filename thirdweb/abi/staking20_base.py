"""Generated wrapper for Staking20Base Solidity contract."""
...
# constructor for Staking20Base below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        Staking20BaseValidator,
    )
except ImportError:

    class Staking20BaseValidator(Validator):  # type: ignore
...
class Staking20Base:
    """Wrapper class for Staking20Base Solidity contract."""
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: Staking20BaseValidator = None,
    ):
        ...
        if not validator:
            validator = Staking20BaseValidator(
