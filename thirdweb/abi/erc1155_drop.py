"""Generated wrapper for ERC1155Drop Solidity contract."""
...
# constructor for ERC1155Drop below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        ERC1155DropValidator,
    )
except ImportError:

    class ERC1155DropValidator(Validator):  # type: ignore
...
class ERC1155Drop:
    """Wrapper class for ERC1155Drop Solidity contract.
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: ERC1155DropValidator = None,
    ):
        ...
        if not validator:
            validator = ERC1155DropValidator(
