"""Generated wrapper for IERC1155Receiver Solidity contract."""
...
# constructor for IERC1155Receiver below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        IERC1155ReceiverValidator,
    )
except ImportError:

    class IERC1155ReceiverValidator(Validator):  # type: ignore
...
class IERC1155Receiver:
    """Wrapper class for IERC1155Receiver Solidity contract.
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: IERC1155ReceiverValidator = None,
    ):
        ...
        if not validator:
            validator = IERC1155ReceiverValidator(
