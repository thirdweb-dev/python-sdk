...
class NativeTokenMethod(ContractMethod): # pylint: disable=invalid-name
    """Various interfaces to the NATIVE_TOKEN method."""
...
class AcceptOfferMethod(ContractMethod): # pylint: disable=invalid-name
    ...
    def validate_and_normalize_inputs(self, listing_id: int, offeror: str):
        ...
        self.validator.assert_valid(
            method_name='acceptOffer',
            parameter_name='offeror',
            argument_value=offeror,
        )
        offeror = self.validate_and_checksum_address(offeror)
        return (listing_id, offeror)

    def call(self, listing_id: int, offeror: str, tx_params: Optional[TxParams] = None) -> None:
        """Execute underlying contract method via eth_call.

        :param tx_params: transaction parameters
        :returns: the return value of the underlying method.
        """
        (listing_id, offeror) = self.validate_and_normalize_inputs(listing_id, offeror)
        tx_params = super().normalize_tx_params(tx_params)
        self._underlying_method(listing_id, offeror).call(tx_params.as_dict())

    def send_transaction(self, listing_id: int, offeror: str, tx_params: Optional[TxParams] = None) -> Union[HexBytes, bytes]:
        """Execute underlying contract method via eth_sendTransaction.
        ...
        (listing_id, offeror) = self.validate_and_normalize_inputs(listing_id, offeror)
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(listing_id, offeror).transact(tx_params.as_dict())

    def build_transaction(self, listing_id: int, offeror: str, tx_params: Optional[TxParams] = None) -> dict:
        """Construct calldata to be used as input to the method."""
        (listing_id, offeror) = self.validate_and_normalize_inputs(listing_id, offeror)
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(listing_id, offeror).buildTransaction(tx_params.as_dict())

    def estimate_gas(self, listing_id: int, offeror: str, tx_params: Optional[TxParams] = None) -> int:
        """Estimate gas consumption of method call."""
        (listing_id, offeror) = self.validate_and_normalize_inputs(listing_id, offeror)
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(listing_id, offeror).estimateGas(tx_params.as_dict())
...
class BuyMethod(ContractMethod): # pylint: disable=invalid-name
    ...
    def validate_and_normalize_inputs(self, listing_id: int, quantity_to_buy: int):
        ...
        return (listing_id, quantity_to_buy)

    def call(self, listing_id: int, quantity_to_buy: int, tx_params: Optional[TxParams] = None) -> None:
        """Execute underlying contract method via eth_call.

        :param tx_params: transaction parameters
        :returns: the return value of the underlying method.
        """
        (listing_id, quantity_to_buy) = self.validate_and_normalize_inputs(listing_id, quantity_to_buy)
        tx_params = super().normalize_tx_params(tx_params)
        self._underlying_method(listing_id, quantity_to_buy).call(tx_params.as_dict())

    def send_transaction(self, listing_id: int, quantity_to_buy: int, tx_params: Optional[TxParams] = None) -> Union[HexBytes, bytes]:
        """Execute underlying contract method via eth_sendTransaction.
        ...
        (listing_id, quantity_to_buy) = self.validate_and_normalize_inputs(listing_id, quantity_to_buy)
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(listing_id, quantity_to_buy).transact(tx_params.as_dict())

    def build_transaction(self, listing_id: int, quantity_to_buy: int, tx_params: Optional[TxParams] = None) -> dict:
        """Construct calldata to be used as input to the method."""
        (listing_id, quantity_to_buy) = self.validate_and_normalize_inputs(listing_id, quantity_to_buy)
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(listing_id, quantity_to_buy).buildTransaction(tx_params.as_dict())

    def estimate_gas(self, listing_id: int, quantity_to_buy: int, tx_params: Optional[TxParams] = None) -> int:
        """Estimate gas consumption of method call."""
        (listing_id, quantity_to_buy) = self.validate_and_normalize_inputs(listing_id, quantity_to_buy)
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(listing_id, quantity_to_buy).estimateGas(tx_params.as_dict())
...
class OfferMethod(ContractMethod): # pylint: disable=invalid-name
    ...
    def validate_and_normalize_inputs(self, listing_id: int, quantity_wanted: int, currency: str, price_per_token: int):
        ...
        return (listing_id, quantity_wanted, currency, price_per_token)

    def call(self, listing_id: int, quantity_wanted: int, currency: str, price_per_token: int, tx_params: Optional[TxParams] = None) -> None:
        """Execute underlying contract method via eth_call.

        :param tx_params: transaction parameters
        :returns: the return value of the underlying method.
        """
        (listing_id, quantity_wanted, currency, price_per_token) = self.validate_and_normalize_inputs(listing_id, quantity_wanted, currency, price_per_token)
        tx_params = super().normalize_tx_params(tx_params)
        self._underlying_method(listing_id, quantity_wanted, currency, price_per_token).call(tx_params.as_dict())

    def send_transaction(self, listing_id: int, quantity_wanted: int, currency: str, price_per_token: int, tx_params: Optional[TxParams] = None) -> Union[HexBytes, bytes]:
        """Execute underlying contract method via eth_sendTransaction.
        ...
        (listing_id, quantity_wanted, currency, price_per_token) = self.validate_and_normalize_inputs(listing_id, quantity_wanted, currency, price_per_token)
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(listing_id, quantity_wanted, currency, price_per_token).transact(tx_params.as_dict())

    def build_transaction(self, listing_id: int, quantity_wanted: int, currency: str, price_per_token: int, tx_params: Optional[TxParams] = None) -> dict:
        """Construct calldata to be used as input to the method."""
        (listing_id, quantity_wanted, currency, price_per_token) = self.validate_and_normalize_inputs(listing_id, quantity_wanted, currency, price_per_token)
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(listing_id, quantity_wanted, currency, price_per_token).buildTransaction(tx_params.as_dict())

    def estimate_gas(self, listing_id: int, quantity_wanted: int, currency: str, price_per_token: int, tx_params: Optional[TxParams] = None) -> int:
        """Estimate gas consumption of method call."""
        (listing_id, quantity_wanted, currency, price_per_token) = self.validate_and_normalize_inputs(listing_id, quantity_wanted, currency, price_per_token)
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(listing_id, quantity_wanted, currency, price_per_token).estimateGas(tx_params.as_dict())
...
class OffersMethod(ContractMethod): # pylint: disable=invalid-name
    ...
    def call(self, index_0: int, index_1: str, tx_params: Optional[TxParams] = None) -> Tuple[int, str, int, str, int]:
        """Execute underlying contract method via eth_call.
        ...
        return (returned[0],returned[1],returned[2],returned[3],returned[4],)
...
class RestrictedListerRoleOnlyMethod(ContractMethod): # pylint: disable=invalid-name
...
class SetRestrictedListerRoleOnlyMethod(ContractMethod): # pylint: disable=invalid-name
    ...
    def call(self, restricted: bool, tx_params: Optional[TxParams] = None) -> None:
        """Execute underlying contract method via eth_call.
    ...
    def send_transaction(self, restricted: bool, tx_params: Optional[TxParams] = None) -> Union[HexBytes, bytes]:
        """Execute underlying contract method via eth_sendTransaction.
        ...
        (restricted) = self.validate_and_normalize_inputs(restricted)
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(restricted).transact(tx_params.as_dict())

    def build_transaction(self, restricted: bool, tx_params: Optional[TxParams] = None) -> dict:
        """Construct calldata to be used as input to the method."""
        (restricted) = self.validate_and_normalize_inputs(restricted)
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(restricted).buildTransaction(tx_params.as_dict())

    def estimate_gas(self, restricted: bool, tx_params: Optional[TxParams] = None) -> int:
        """Estimate gas consumption of method call."""
        (restricted) = self.validate_and_normalize_inputs(restricted)
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(restricted).estimateGas(tx_params.as_dict())
...
class WinningBidMethod(ContractMethod): # pylint: disable=invalid-name
    ...
    def call(self, index_0: int, tx_params: Optional[TxParams] = None) -> Tuple[int, str, int, str, int]:
        """Execute underlying contract method via eth_call.
...
class Marketplace:
    ...
    native_token: NativeTokenMethod
    """Constructor-initialized instance of
    :class:`NativeTokenMethod`.
    """
    ...
    def __init__(
        ...
        self.lister_role = ListerRoleMethod(web3_or_provider, contract_address, functions.LISTER_ROLE)

        self.max_bps = MaxBpsMethod(web3_or_provider, contract_address, functions.MAX_BPS)

        self.native_token = NativeTokenMethod(web3_or_provider, contract_address, functions.NATIVE_TOKEN)
        ...
        self.native_token_wrapper = NativeTokenWrapperMethod(web3_or_provider, contract_address, functions.nativeTokenWrapper)
        ...
        self.restricted_lister_role_only = RestrictedListerRoleOnlyMethod(web3_or_provider, contract_address, functions.restrictedListerRoleOnly)
        ...
        self.set_restricted_lister_role_only = SetRestrictedListerRoleOnlyMethod(web3_or_provider, contract_address, functions.setRestrictedListerRoleOnly, validator)
    ...
    def get_listing_restricted_event(
        self, tx_hash: Union[HexBytes, bytes]
    ) -> Tuple[AttributeDict]:
        """Get log entry for ListingRestricted event.

        :param tx_hash: hash of transaction emitting ListingRestricted event
        """
        tx_receipt = self._web3_eth.getTransactionReceipt(tx_hash)
        return self._web3_eth.contract(address=to_checksum_address(self.contract_address), abi=Marketplace.abi()).events.ListingRestricted().processReceipt(tx_receipt)
    def get_listing_update_event(
        ...
        """
        tx_receipt = self._web3_eth.getTransactionReceipt(tx_hash)
        return self._web3_eth.contract(address=to_checksum_address(self.contract_address), abi=Marketplace.abi()).events.ListingUpdate().processReceipt(tx_receipt)
    def get_market_fee_update_event(
        ...
        """
        tx_receipt = self._web3_eth.getTransactionReceipt(tx_hash)
        return self._web3_eth.contract(address=to_checksum_address(self.contract_address), abi=Marketplace.abi()).events.MarketFeeUpdate().processReceipt(tx_receipt)
    def get_new_listing_event(
        ...
        """
        tx_receipt = self._web3_eth.getTransactionReceipt(tx_hash)
        return self._web3_eth.contract(address=to_checksum_address(self.contract_address), abi=Marketplace.abi()).events.NewListing().processReceipt(tx_receipt)
