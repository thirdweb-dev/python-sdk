"""Generated wrapper for IMintableERC721 Solidity contract."""
...
# constructor for IMintableERC721 below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        IMintableERC721Validator,
    )
except ImportError:

    class IMintableERC721Validator(Validator):  # type: ignore
...
class IMintableERC721:
    """Wrapper class for IMintableERC721 Solidity contract."""
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: IMintableERC721Validator = None,
    ):
        ...
        if not validator:
            validator = IMintableERC721Validator(
