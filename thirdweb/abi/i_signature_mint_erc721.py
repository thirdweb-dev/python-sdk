"""Generated wrapper for ISignatureMintERC721 Solidity contract."""
...
# constructor for ISignatureMintERC721 below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        ISignatureMintERC721Validator,
    )
except ImportError:

    class ISignatureMintERC721Validator(Validator):  # type: ignore
...
class ISignatureMintERC721:
    """Wrapper class for ISignatureMintERC721 Solidity contract.
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: ISignatureMintERC721Validator = None,
    ):
        ...
        if not validator:
            validator = ISignatureMintERC721Validator(
