"""Generated wrapper for LazyMint Solidity contract."""
...
# constructor for LazyMint below.
try:
    ...
    class LazyMintValidator(Validator):  # type: ignore
...
class LazyMint:
    """Wrapper class for LazyMint Solidity contract.
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: LazyMintValidator = None,
    ):
        ...
        if not validator:
            validator = LazyMintValidator(web3_or_provider, contract_address)
        ...
        functions = self._web3_eth.contract(
            address=to_checksum_address(contract_address), abi=LazyMint.abi()
        ).functions
