"""Generated wrapper for PrimarySale Solidity contract."""
...
# constructor for PrimarySale below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        PrimarySaleValidator,
    )
except ImportError:

    class PrimarySaleValidator(Validator):  # type: ignore
...
class PrimarySale:
    """Wrapper class for PrimarySale Solidity contract."""
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: PrimarySaleValidator = None,
    ):
        ...
        if not validator:
            validator = PrimarySaleValidator(
