"""Generated wrapper for IThirdwebPlatformFee Solidity contract."""
...
# constructor for IThirdwebPlatformFee below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        IThirdwebPlatformFeeValidator,
    )
except ImportError:

    class IThirdwebPlatformFeeValidator(  # type: ignore
        Validator
    ):
...
class IThirdwebPlatformFee:
    """Wrapper class for IThirdwebPlatformFee Solidity contract."""
    ...
    def __init__(
        ...
        validator: IThirdwebPlatformFeeValidator = None,
    ):
        ...
        if not validator:
            validator = IThirdwebPlatformFeeValidator(web3_or_provider, contract_address)
        ...
        functions = self._web3_eth.contract(address=to_checksum_address(contract_address), abi=IThirdwebPlatformFee.abi()).functions
    ...
    def get_platform_fee_info_updated_event(
        ...
        return self._web3_eth.contract(address=to_checksum_address(self.contract_address), abi=IThirdwebPlatformFee.abi()).events.PlatformFeeInfoUpdated().processReceipt(tx_receipt)
