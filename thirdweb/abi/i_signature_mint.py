"""Generated wrapper for ISignatureMint Solidity contract."""
...
# constructor for ISignatureMint below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        ISignatureMintValidator,
    )
except ImportError:

    class ISignatureMintValidator(Validator):  # type: ignore
...
class MintWithSignatureMethod(ContractMethod):  # pylint: disable=invalid-name
    ...
    def validate_and_normalize_inputs(
        self, req: ISignatureMintMintRequest, signature: Union[bytes, str]
    ):
...
class ISignatureMint:
    """Wrapper class for ISignatureMint Solidity contract.
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: ISignatureMintValidator = None,
    ):
        ...
        if not validator:
            validator = ISignatureMintValidator(
