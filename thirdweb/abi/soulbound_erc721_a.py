"""Generated wrapper for SoulboundERC721A Solidity contract."""
...
# constructor for SoulboundERC721A below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        SoulboundERC721AValidator,
    )
except ImportError:

    class SoulboundERC721AValidator(Validator):  # type: ignore
...
class RestrictTransfersMethod(ContractMethod):  # pylint: disable=invalid-name
    """Various interfaces to the restrictTransfers method."""
    ...
    def validate_and_normalize_inputs(self, to_restrict: bool):
        """Validate the inputs to the restrictTransfers method."""
        self.validator.assert_valid(
            method_name="restrictTransfers",
            parameter_name="_toRestrict",
            argument_value=to_restrict,
        )
        return to_restrict

    def call(
        self, to_restrict: bool, tx_params: Optional[TxParams] = None
    ) -> None:
        """Execute underlying contract method via eth_call.
        ...
        :returns: the return value of the underlying method.
        """
        (to_restrict) = self.validate_and_normalize_inputs(to_restrict)
        tx_params = super().normalize_tx_params(tx_params)
        self._underlying_method(to_restrict).call(tx_params.as_dict())
    ...
    def send_transaction(
        ...
        (to_restrict) = self.validate_and_normalize_inputs(to_restrict)
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(to_restrict).transact(
            tx_params.as_dict()
        )
    ...
    def build_transaction(
        ...
        (to_restrict) = self.validate_and_normalize_inputs(to_restrict)
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(to_restrict).buildTransaction(
            tx_params.as_dict()
        )
    ...
    def estimate_gas(
        ...
        (to_restrict) = self.validate_and_normalize_inputs(to_restrict)
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(to_restrict).estimateGas(
            tx_params.as_dict()
        )
...
class SoulboundERC721A:
    """Wrapper class for SoulboundERC721A Solidity contract."""
    ...
    restrict_transfers: RestrictTransfersMethod
    """Constructor-initialized instance of
    :class:`RestrictTransfersMethod`.
    """
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: SoulboundERC721AValidator = None,
    ):
        ...
        if not validator:
            validator = SoulboundERC721AValidator(
        ...
        self.restrict_transfers = RestrictTransfersMethod(
            web3_or_provider,
            contract_address,
            functions.restrictTransfers,
            validator,
        )
