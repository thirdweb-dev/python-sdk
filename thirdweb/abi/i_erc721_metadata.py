"""Generated wrapper for IERC721Metadata Solidity contract."""
...
# constructor for IERC721Metadata below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        IERC721MetadataValidator,
    )
except ImportError:

    class IERC721MetadataValidator(Validator):  # type: ignore
...
class IERC721Metadata:
    """Wrapper class for IERC721Metadata Solidity contract."""
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: IERC721MetadataValidator = None,
    ):
        ...
        if not validator:
            validator = IERC721MetadataValidator(
    ...
    def abi():
        ...
        return json.loads(
            '[{"inputs":[],"name":"name","outputs":[{"internalType":"string","name":"","type":"string"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"symbol","outputs":[{"internalType":"string","name":"","type":"string"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"uint256","name":"_tokenId","type":"uint256"}],"name":"tokenURI","outputs":[{"internalType":"string","name":"","type":"string"}],"stateMutability":"view","type":"function"}]'  # noqa: E501 (line-too-long)
        )
