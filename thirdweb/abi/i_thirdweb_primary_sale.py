...
try:
    ...
    class IThirdwebPrimarySaleValidator(  # type: ignore
        Validator
    ):
...
class IThirdwebPrimarySale:
    ...
    def __init__(
        ...
        if not validator:
            validator = IThirdwebPrimarySaleValidator(web3_or_provider, contract_address)
        ...
        functions = self._web3_eth.contract(address=to_checksum_address(contract_address), abi=IThirdwebPrimarySale.abi()).functions
    ...
    def get_primary_sale_recipient_updated_event(
        ...
        return self._web3_eth.contract(address=to_checksum_address(self.contract_address), abi=IThirdwebPrimarySale.abi()).events.PrimarySaleRecipientUpdated().processReceipt(tx_receipt)
