"""Generated wrapper for ERC20Base Solidity contract."""
...
# constructor for ERC20Base below.
try:
    ...
    class ERC20BaseValidator(Validator):  # type: ignore
...
class ERC20Base:
    """Wrapper class for ERC20Base Solidity contract."""
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: ERC20BaseValidator = None,
    ):
        ...
        if not validator:
            validator = ERC20BaseValidator(web3_or_provider, contract_address)
        ...
        functions = self._web3_eth.contract(
            address=to_checksum_address(contract_address), abi=ERC20Base.abi()
        ).functions
