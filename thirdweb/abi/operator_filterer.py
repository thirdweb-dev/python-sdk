"""Generated wrapper for OperatorFilterer Solidity contract."""
...
# constructor for OperatorFilterer below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        OperatorFiltererValidator,
    )
except ImportError:

    class OperatorFiltererValidator(Validator):  # type: ignore
...
class OperatorFilterer:
    """Wrapper class for OperatorFilterer Solidity contract."""
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: OperatorFiltererValidator = None,
    ):
        ...
        if not validator:
            validator = OperatorFiltererValidator(
