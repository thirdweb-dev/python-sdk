"""Generated wrapper for ISignatureMintERC20 Solidity contract."""
...
# constructor for ISignatureMintERC20 below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        ISignatureMintERC20Validator,
    )
except ImportError:

    class ISignatureMintERC20Validator(Validator):  # type: ignore
...
class ISignatureMintERC20:
    """Wrapper class for ISignatureMintERC20 Solidity contract.
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: ISignatureMintERC20Validator = None,
    ):
        ...
        if not validator:
            validator = ISignatureMintERC20Validator(
