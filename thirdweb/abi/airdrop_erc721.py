"""Generated wrapper for AirdropERC721 Solidity contract."""
...
# constructor for AirdropERC721 below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        AirdropERC721Validator,
    )
except ImportError:

    class AirdropERC721Validator(Validator):  # type: ignore
...
class IAirdropERC721AirdropContent(TypedDict):
...
class AddAirdropRecipientsMethod(
    ...
    def validate_and_normalize_inputs(
        self, contents: List[IAirdropERC721AirdropContent]
    ):
    ...
    def call(
        self,
        contents: List[IAirdropERC721AirdropContent],
...
class GetAllAirdropPaymentsMethod(
    ...
    def call(
        self, tx_params: Optional[TxParams] = None
    ) -> List[IAirdropERC721AirdropContent]:
        """Execute underlying contract method via eth_call.
...
class AirdropERC721:
    """Wrapper class for AirdropERC721 Solidity contract."""
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: AirdropERC721Validator = None,
    ):
        ...
        if not validator:
            validator = AirdropERC721Validator(
