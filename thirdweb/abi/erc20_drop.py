"""Generated wrapper for ERC20Drop Solidity contract."""
...
# constructor for ERC20Drop below.
try:
    ...
    class ERC20DropValidator(Validator):  # type: ignore
...
class ERC20Drop:
    """Wrapper class for ERC20Drop Solidity contract.
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: ERC20DropValidator = None,
    ):
        ...
        if not validator:
            validator = ERC20DropValidator(web3_or_provider, contract_address)
        ...
        functions = self._web3_eth.contract(
            address=to_checksum_address(contract_address), abi=ERC20Drop.abi()
        ).functions
