"""Generated wrapper for IContractPublisher Solidity contract."""
...
# constructor for IContractPublisher below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        IContractPublisherValidator,
    )
except ImportError:

    class IContractPublisherValidator(Validator):  # type: ignore
...
class IContractPublisher:
    """Wrapper class for IContractPublisher Solidity contract."""
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: IContractPublisherValidator = None,
    ):
        ...
        if not validator:
            validator = IContractPublisherValidator(
