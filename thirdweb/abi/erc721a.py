"""Generated wrapper for ERC721A Solidity contract."""
...
try:
    ...
    class ERC721AValidator(Validator):  # type: ignore
...
class ERC721A:
    """Wrapper class for ERC721A Solidity contract.
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: ERC721AValidator = None,
    ):
        ...
        if not validator:
            validator = ERC721AValidator(web3_or_provider, contract_address)
        ...
        functions = self._web3_eth.contract(
            address=to_checksum_address(contract_address), abi=ERC721A.abi()
        ).functions
