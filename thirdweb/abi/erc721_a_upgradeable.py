"""Generated wrapper for ERC721AUpgradeable Solidity contract."""
...
# constructor for ERC721AUpgradeable below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        ERC721AUpgradeableValidator,
    )
except ImportError:

    class ERC721AUpgradeableValidator(Validator):  # type: ignore
...
class ERC721AUpgradeable:
    """Wrapper class for ERC721AUpgradeable Solidity contract.
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: ERC721AUpgradeableValidator = None,
    ):
        ...
        if not validator:
            validator = ERC721AUpgradeableValidator(
