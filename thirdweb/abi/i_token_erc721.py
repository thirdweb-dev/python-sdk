...
try:
    ...
    class ITokenERC721Validator(Validator):  # type: ignore
...
class ITokenERC721:
    ...
    def __init__(
        ...
        if not validator:
            validator = ITokenERC721Validator(
