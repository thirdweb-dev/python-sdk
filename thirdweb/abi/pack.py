...
class AddPackContentsMethod(ContractMethod):  # pylint: disable=invalid-name
    """Various interfaces to the addPackContents method."""
    ...
    def validate_and_normalize_inputs(
        ...
        """Validate the inputs to the addPackContents method."""
        self.validator.assert_valid(
            method_name="addPackContents",
        ...
        return (pack_id, contents, num_of_reward_units, recipient)
    ...
    def call(
        ...
        (
            ...
            pack_id, contents, num_of_reward_units, recipient
        )
        tx_params = super().normalize_tx_params(tx_params)
...
class CanUpdatePackMethod(ContractMethod):  # pylint: disable=invalid-name
    """Various interfaces to the canUpdatePack method."""
    ...
    def validate_and_normalize_inputs(self, index_0: int):
        """Validate the inputs to the canUpdatePack method."""
        self.validator.assert_valid(
            method_name="canUpdatePack",
...
class Pack:
    ...
    add_pack_contents: AddPackContentsMethod
    """Constructor-initialized instance of
    :class:`AddPackContentsMethod`.
    """
    ...
    can_update_pack: CanUpdatePackMethod
    """Constructor-initialized instance of
    :class:`CanUpdatePackMethod`.
    """
    ...
    def __init__(
        ...
        self.add_pack_contents = AddPackContentsMethod(
            web3_or_provider,
            contract_address,
            functions.addPackContents,
            validator,
        )
        ...
        self.can_update_pack = CanUpdatePackMethod(
            web3_or_provider,
            contract_address,
            functions.canUpdatePack,
            validator,
        )
