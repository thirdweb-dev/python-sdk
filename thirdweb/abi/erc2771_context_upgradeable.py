"""Generated wrapper for ERC2771ContextUpgradeable Solidity contract."""
...
# constructor for ERC2771ContextUpgradeable below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        ERC2771ContextUpgradeableValidator,
    )
except ImportError:

    class ERC2771ContextUpgradeableValidator(Validator):  # type: ignore
...
class ERC2771ContextUpgradeable:
    """Wrapper class for ERC2771ContextUpgradeable Solidity contract."""
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: ERC2771ContextUpgradeableValidator = None,
    ):
        ...
        if not validator:
            validator = ERC2771ContextUpgradeableValidator(
        ...
        functions = self._web3_eth.contract(
            ...
            abi=ERC2771ContextUpgradeable.abi(),
        ).functions
    ...
    def abi():
        ...
        return json.loads(
            '[{"anonymous":false,"inputs":[{"indexed":false,"internalType":"uint8","name":"version","type":"uint8"}],"name":"Initialized","type":"event"},{"inputs":[{"internalType":"address","name":"forwarder","type":"address"}],"name":"isTrustedForwarder","outputs":[{"internalType":"bool","name":"","type":"bool"}],"stateMutability":"view","type":"function"}]'  # noqa: E501 (line-too-long)
        )
