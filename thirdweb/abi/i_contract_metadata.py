"""Generated wrapper for IContractMetadata Solidity contract."""
...
# constructor for IContractMetadata below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        IContractMetadataValidator,
    )
except ImportError:

    class IContractMetadataValidator(Validator):  # type: ignore
...
class IContractMetadata:
    """Wrapper class for IContractMetadata Solidity contract."""
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: IContractMetadataValidator = None,
    ):
        ...
        if not validator:
            validator = IContractMetadataValidator(
