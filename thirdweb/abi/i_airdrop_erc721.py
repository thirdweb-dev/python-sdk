"""Generated wrapper for IAirdropERC721 Solidity contract."""
...
# constructor for IAirdropERC721 below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        IAirdropERC721Validator,
    )
except ImportError:

    class IAirdropERC721Validator(Validator):  # type: ignore
...
class IAirdropERC721:
    """Wrapper class for IAirdropERC721 Solidity contract."""
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: IAirdropERC721Validator = None,
    ):
        ...
        if not validator:
            validator = IAirdropERC721Validator(
