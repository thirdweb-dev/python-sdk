"""Generated wrapper for ERC20Permit Solidity contract."""
...
# constructor for ERC20Permit below.
try:
    ...
    class ERC20PermitValidator(Validator):  # type: ignore
...
class ERC20Permit:
    """Wrapper class for ERC20Permit Solidity contract."""
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: ERC20PermitValidator = None,
    ):
        ...
        if not validator:
            validator = ERC20PermitValidator(
