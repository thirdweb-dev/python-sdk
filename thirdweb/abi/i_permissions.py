"""Generated wrapper for IPermissions Solidity contract."""
...
# constructor for IPermissions below.
try:
    ...
    class IPermissionsValidator(Validator):  # type: ignore
...
class IPermissions:
    """Wrapper class for IPermissions Solidity contract."""
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: IPermissionsValidator = None,
    ):
        ...
        if not validator:
            validator = IPermissionsValidator(
