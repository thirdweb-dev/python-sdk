...
try:
    ...
    class IERC20Validator(Validator):  # type: ignore
...
class ApproveMethod(ContractMethod):  # pylint: disable=invalid-name
    ...
    def call(
        self, spender: str, value: int, tx_params: Optional[TxParams] = None
    ) -> bool:
        """Execute underlying contract method via eth_call.
        ...
        tx_params = super().normalize_tx_params(tx_params)
        returned = self._underlying_method(spender, value).call(
            tx_params.as_dict()
        )
    ...
    def send_transaction(
        ...
        (spender, value) = self.validate_and_normalize_inputs(spender, value)
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(spender, value).transact(
            tx_params.as_dict()
        )
    ...
    def build_transaction(
        ...
        (spender, value) = self.validate_and_normalize_inputs(spender, value)
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(spender, value).buildTransaction(
            tx_params.as_dict()
        )
    ...
    def estimate_gas(
        ...
        (spender, value) = self.validate_and_normalize_inputs(spender, value)
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(spender, value).estimateGas(
            tx_params.as_dict()
        )
...
class BalanceOfMethod(ContractMethod):  # pylint: disable=invalid-name
    ...
    def send_transaction(
        self, who: str, tx_params: Optional[TxParams] = None
    ) -> Union[HexBytes, bytes]:
        """Execute underlying contract method via eth_sendTransaction.
    ...
    def build_transaction(
        ...
        (who) = self.validate_and_normalize_inputs(who)
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(who).buildTransaction(
            tx_params.as_dict()
        )
...
class TransferFromMethod(ContractMethod):  # pylint: disable=invalid-name
    ...
    def call(
        ...
        :returns: the return value of the underlying method.
        """
        (_from, to, value) = self.validate_and_normalize_inputs(
            _from, to, value
        )
        tx_params = super().normalize_tx_params(tx_params)
        returned = self._underlying_method(_from, to, value).call(
            tx_params.as_dict()
        )
        return bool(returned)
    ...
    def send_transaction(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(_from, to, value).transact(
            tx_params.as_dict()
        )
    ...
    def build_transaction(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(_from, to, value).buildTransaction(
            tx_params.as_dict()
        )
    ...
    def estimate_gas(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(_from, to, value).estimateGas(
            tx_params.as_dict()
        )
...
class IERC20:
    ...
    def __init__(
        ...
        functions = self._web3_eth.contract(
            address=to_checksum_address(contract_address), abi=IERC20.abi()
        ).functions
