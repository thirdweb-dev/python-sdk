"""Generated wrapper for IDrop Solidity contract."""
...
try:
    ...
    class IDropValidator(Validator):  # type: ignore
...
class IDrop:
    """Wrapper class for IDrop Solidity contract.
    ...
    def __init__(
        ...
        if not validator:
            validator = IDropValidator(web3_or_provider, contract_address)
        ...
        functions = self._web3_eth.contract(
            address=to_checksum_address(contract_address), abi=IDrop.abi()
        ).functions
