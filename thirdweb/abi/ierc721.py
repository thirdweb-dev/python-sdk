...
try:
    ...
    class IERC721Validator(Validator):  # type: ignore
...
class ApproveMethod(ContractMethod):  # pylint: disable=invalid-name
    ...
    def call(
        ...
        """
        (approved, token_id) = self.validate_and_normalize_inputs(
            approved, token_id
        )
    ...
    def send_transaction(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(approved, token_id).transact(
            tx_params.as_dict()
        )
    ...
    def build_transaction(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(approved, token_id).buildTransaction(
            tx_params.as_dict()
        )
    ...
    def estimate_gas(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(approved, token_id).estimateGas(
            tx_params.as_dict()
        )
...
class IERC721:
    ...
    def __init__(
        ...
        functions = self._web3_eth.contract(
            address=to_checksum_address(contract_address), abi=IERC721.abi()
        ).functions
