"""Generated wrapper for PermissionsEnumerable Solidity contract."""
...
# constructor for PermissionsEnumerable below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        PermissionsEnumerableValidator,
    )
except ImportError:

    class PermissionsEnumerableValidator(Validator):  # type: ignore
...
class PermissionsEnumerable:
    """Wrapper class for PermissionsEnumerable Solidity contract."""
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: PermissionsEnumerableValidator = None,
    ):
        ...
        if not validator:
            validator = PermissionsEnumerableValidator(
