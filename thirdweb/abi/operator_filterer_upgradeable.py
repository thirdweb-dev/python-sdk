"""Generated wrapper for OperatorFiltererUpgradeable Solidity contract."""
...
# constructor for OperatorFiltererUpgradeable below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        OperatorFiltererUpgradeableValidator,
    )
except ImportError:

    class OperatorFiltererUpgradeableValidator(Validator):  # type: ignore
...
class OperatorFiltererUpgradeable:
    """Wrapper class for OperatorFiltererUpgradeable Solidity contract."""
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: OperatorFiltererUpgradeableValidator = None,
    ):
        ...
        if not validator:
            validator = OperatorFiltererUpgradeableValidator(
        ...
        functions = self._web3_eth.contract(
            ...
            abi=OperatorFiltererUpgradeable.abi(),
        ).functions
