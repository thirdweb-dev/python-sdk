"""Generated wrapper for ERC2771Context Solidity contract."""
...
# constructor for ERC2771Context below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        ERC2771ContextValidator,
    )
except ImportError:

    class ERC2771ContextValidator(Validator):  # type: ignore
...
class ERC2771Context:
    """Wrapper class for ERC2771Context Solidity contract."""
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: ERC2771ContextValidator = None,
    ):
        ...
        if not validator:
            validator = ERC2771ContextValidator(
