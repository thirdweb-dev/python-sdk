"""Generated wrapper for IClaimableERC1155 Solidity contract."""
...
# constructor for IClaimableERC1155 below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        IClaimableERC1155Validator,
    )
except ImportError:

    class IClaimableERC1155Validator(Validator):  # type: ignore
...
class IClaimableERC1155:
    """Wrapper class for IClaimableERC1155 Solidity contract."""
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: IClaimableERC1155Validator = None,
    ):
        ...
        if not validator:
            validator = IClaimableERC1155Validator(
