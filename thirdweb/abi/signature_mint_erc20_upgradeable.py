"""Generated wrapper for SignatureMintERC20Upgradeable Solidity contract."""
...
# constructor for SignatureMintERC20Upgradeable below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        SignatureMintERC20UpgradeableValidator,
    )
except ImportError:

    class SignatureMintERC20UpgradeableValidator(Validator):  # type: ignore
...
class MintWithSignatureMethod(ContractMethod):  # pylint: disable=invalid-name
    ...
    def validate_and_normalize_inputs(
        self, req: ISignatureMintERC20MintRequest, signature: Union[bytes, str]
    ):
    ...
    def call(
        self,
        req: ISignatureMintERC20MintRequest,
...
class SignatureMintERC20Upgradeable:
    """Wrapper class for SignatureMintERC20Upgradeable Solidity contract.
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: SignatureMintERC20UpgradeableValidator = None,
    ):
        ...
        if not validator:
            validator = SignatureMintERC20UpgradeableValidator(
        ...
        functions = self._web3_eth.contract(
            ...
            abi=SignatureMintERC20Upgradeable.abi(),
        ).functions
