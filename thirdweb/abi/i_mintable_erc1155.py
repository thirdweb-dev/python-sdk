"""Generated wrapper for IMintableERC1155 Solidity contract."""
...
# constructor for IMintableERC1155 below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        IMintableERC1155Validator,
    )
except ImportError:

    class IMintableERC1155Validator(Validator):  # type: ignore
...
class IMintableERC1155:
    """Wrapper class for IMintableERC1155 Solidity contract."""
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: IMintableERC1155Validator = None,
    ):
        ...
        if not validator:
            validator = IMintableERC1155Validator(
