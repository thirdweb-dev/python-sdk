"""Generated wrapper for TWMultichainRegistryLogic Solidity contract."""
...
# constructor for TWMultichainRegistryLogic below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        TWMultichainRegistryLogicValidator,
    )
except ImportError:

    class TWMultichainRegistryLogicValidator(Validator):  # type: ignore
...
class TWMultichainRegistryLogic:
    """Wrapper class for TWMultichainRegistryLogic Solidity contract."""
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: TWMultichainRegistryLogicValidator = None,
    ):
        ...
        if not validator:
            validator = TWMultichainRegistryLogicValidator(
        ...
        functions = self._web3_eth.contract(
            ...
            abi=TWMultichainRegistryLogic.abi(),
        ).functions
