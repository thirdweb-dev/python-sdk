"""Generated wrapper for SignatureDrop_V4 Solidity contract."""
...
# constructor for SignatureDrop_V4 below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        SignatureDrop_V4Validator,
    )
except ImportError:

    class SignatureDrop_V4Validator(Validator):  # type: ignore
...
class SignatureDrop_V4:
    """Wrapper class for SignatureDrop_V4 Solidity contract.
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: SignatureDrop_V4Validator = None,
    ):
        ...
        if not validator:
            validator = SignatureDrop_V4Validator(
