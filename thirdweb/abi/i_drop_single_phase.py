"""Generated wrapper for IDropSinglePhase Solidity contract."""
...
# constructor for IDropSinglePhase below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        IDropSinglePhaseValidator,
    )
except ImportError:

    class IDropSinglePhaseValidator(Validator):  # type: ignore
...
class IDropSinglePhase:
    """Wrapper class for IDropSinglePhase Solidity contract.
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: IDropSinglePhaseValidator = None,
    ):
        ...
        if not validator:
            validator = IDropSinglePhaseValidator(
