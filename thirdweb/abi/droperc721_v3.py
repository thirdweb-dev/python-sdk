...
try:
    ...
    class DropERC721_V3Validator(Validator):  # type: ignore
...
class LazyMintMethod(ContractMethod):  # pylint: disable=invalid-name
    ...
    def call(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        self._underlying_method(amount, base_uri_for_tokens, data).call(
            tx_params.as_dict()
        )
...
class DropERC721_V3:
    ...
    def __init__(
        ...
        if not validator:
            validator = DropERC721_V3Validator(
