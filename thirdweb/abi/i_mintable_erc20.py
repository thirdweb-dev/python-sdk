"""Generated wrapper for IMintableERC20 Solidity contract."""
...
# constructor for IMintableERC20 below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        IMintableERC20Validator,
    )
except ImportError:

    class IMintableERC20Validator(Validator):  # type: ignore
...
class IMintableERC20:
    """Wrapper class for IMintableERC20 Solidity contract."""
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: IMintableERC20Validator = None,
    ):
        ...
        if not validator:
            validator = IMintableERC20Validator(
