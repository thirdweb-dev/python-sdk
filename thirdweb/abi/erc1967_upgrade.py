"""Generated wrapper for ERC1967Upgrade Solidity contract."""
...
# constructor for ERC1967Upgrade below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        ERC1967UpgradeValidator,
    )
except ImportError:

    class ERC1967UpgradeValidator(Validator):  # type: ignore
...
class ERC1967Upgrade:
    """Wrapper class for ERC1967Upgrade Solidity contract."""

    def __init__(
        self,
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: ERC1967UpgradeValidator = None,
    ):
        ...
        if not validator:
            validator = ERC1967UpgradeValidator(
