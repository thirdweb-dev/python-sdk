...
try:
    ...
    class ITokenERC1155Validator(Validator):  # type: ignore
...
class ITokenERC1155:
    ...
    def __init__(
        ...
        if not validator:
            validator = ITokenERC1155Validator(
