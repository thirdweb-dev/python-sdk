"""Generated wrapper for ContractMetadata Solidity contract."""
...
# constructor for ContractMetadata below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        ContractMetadataValidator,
    )
except ImportError:

    class ContractMetadataValidator(Validator):  # type: ignore
...
class ContractMetadata:
    """Wrapper class for ContractMetadata Solidity contract."""
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: ContractMetadataValidator = None,
    ):
        ...
        if not validator:
            validator = ContractMetadataValidator(
