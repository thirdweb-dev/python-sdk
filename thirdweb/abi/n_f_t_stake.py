"""Generated wrapper for NFTStake Solidity contract."""
...
# constructor for NFTStake below.
try:
    ...
    class NFTStakeValidator(Validator):  # type: ignore
...
class NFTStake:
    """Wrapper class for NFTStake Solidity contract.
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: NFTStakeValidator = None,
    ):
        ...
        if not validator:
            validator = NFTStakeValidator(web3_or_provider, contract_address)
        ...
        functions = self._web3_eth.contract(
            address=to_checksum_address(contract_address), abi=NFTStake.abi()
        ).functions
