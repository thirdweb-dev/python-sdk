"""Generated wrapper for IDropERC20_V2 Solidity contract."""
...
# constructor for IDropERC20_V2 below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        IDropERC20_V2Validator,
    )
except ImportError:

    class IDropERC20_V2Validator(Validator):  # type: ignore
...
class IDropERC20_V2:
    """Wrapper class for IDropERC20_V2 Solidity contract."""
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: IDropERC20_V2Validator = None,
    ):
        ...
        if not validator:
            validator = IDropERC20_V2Validator(
