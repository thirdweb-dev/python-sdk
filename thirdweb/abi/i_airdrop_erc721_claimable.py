"""Generated wrapper for IAirdropERC721Claimable Solidity contract."""
...
# constructor for IAirdropERC721Claimable below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        IAirdropERC721ClaimableValidator,
    )
except ImportError:

    class IAirdropERC721ClaimableValidator(Validator):  # type: ignore
...
class IAirdropERC721Claimable:
    """Wrapper class for IAirdropERC721Claimable Solidity contract."""
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: IAirdropERC721ClaimableValidator = None,
    ):
        ...
        if not validator:
            validator = IAirdropERC721ClaimableValidator(
        ...
        functions = self._web3_eth.contract(
            ...
            abi=IAirdropERC721Claimable.abi(),
        ).functions
