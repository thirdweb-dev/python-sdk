"""Generated wrapper for IEnglishAuctions Solidity contract."""
...
# constructor for IEnglishAuctions below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        IEnglishAuctionsValidator,
    )
except ImportError:

    class IEnglishAuctionsValidator(Validator):  # type: ignore
...
class IEnglishAuctions:
    """Wrapper class for IEnglishAuctions Solidity contract."""
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: IEnglishAuctionsValidator = None,
    ):
        ...
        if not validator:
            validator = IEnglishAuctionsValidator(
