...
try:
    ...
    class IThirdwebRoyaltyValidator(  # type: ignore
        Validator
    ):
...
class IThirdwebRoyalty:
    ...
    def __init__(
        ...
        if not validator:
            validator = IThirdwebRoyaltyValidator(web3_or_provider, contract_address)
        ...
        functions = self._web3_eth.contract(address=to_checksum_address(contract_address), abi=IThirdwebRoyalty.abi()).functions
    ...
    def get_default_royalty_event(
        ...
        return self._web3_eth.contract(address=to_checksum_address(self.contract_address), abi=IThirdwebRoyalty.abi()).events.DefaultRoyalty().processReceipt(tx_receipt)
    def get_royalty_for_token_event(
        ...
        """
        tx_receipt = self._web3_eth.getTransactionReceipt(tx_hash)
        return self._web3_eth.contract(address=to_checksum_address(self.contract_address), abi=IThirdwebRoyalty.abi()).events.RoyaltyForToken().processReceipt(tx_receipt)
