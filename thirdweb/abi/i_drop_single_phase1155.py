"""Generated wrapper for IDropSinglePhase1155 Solidity contract."""
...
# constructor for IDropSinglePhase1155 below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        IDropSinglePhase1155Validator,
    )
except ImportError:

    class IDropSinglePhase1155Validator(Validator):  # type: ignore
...
class SetClaimConditionsMethod(ContractMethod):  # pylint: disable=invalid-name
    ...
    def validate_and_normalize_inputs(
        ...
        return (token_id, phase, reset_claim_eligibility)
    ...
    def call(
        ...
        (
            ...
            token_id, phase, reset_claim_eligibility
        )
        tx_params = super().normalize_tx_params(tx_params)
        self._underlying_method(token_id, phase, reset_claim_eligibility).call(
            tx_params.as_dict()
        )
...
class IDropSinglePhase1155:
    """Wrapper class for IDropSinglePhase1155 Solidity contract.
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: IDropSinglePhase1155Validator = None,
    ):
        ...
        if not validator:
            validator = IDropSinglePhase1155Validator(
