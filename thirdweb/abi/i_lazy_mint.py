"""Generated wrapper for ILazyMint Solidity contract."""
...
# constructor for ILazyMint below.
try:
    ...
    class ILazyMintValidator(Validator):  # type: ignore
...
class LazyMintMethod(ContractMethod):  # pylint: disable=invalid-name
    ...
    def validate_and_normalize_inputs(
        ...
        return (amount, base_uri_for_tokens, extra_data)
    ...
    def call(
        ...
        (
            ...
            amount, base_uri_for_tokens, extra_data
        )
...
class ILazyMint:
    """Wrapper class for ILazyMint Solidity contract.
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: ILazyMintValidator = None,
    ):
        ...
        if not validator:
            validator = ILazyMintValidator(web3_or_provider, contract_address)
        ...
        functions = self._web3_eth.contract(
            address=to_checksum_address(contract_address), abi=ILazyMint.abi()
        ).functions
