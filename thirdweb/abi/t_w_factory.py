...
try:
    ...
    class TWFactoryValidator(Validator):  # type: ignore
...
class AddImplementationMethod(ContractMethod):  # pylint: disable=invalid-name
    ...
    def send_transaction(
        ...
        (implementation) = self.validate_and_normalize_inputs(implementation)
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(implementation).transact(
            tx_params.as_dict()
        )
    ...
    def estimate_gas(
        ...
        (implementation) = self.validate_and_normalize_inputs(implementation)
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(implementation).estimateGas(
            tx_params.as_dict()
        )
...
class ApproveImplementationMethod(
    ...
    def validate_and_normalize_inputs(
        self, implementation: str, to_approve: bool
    ):
    ...
    def call(
        ...
        :returns: the return value of the underlying method.
        """
        (implementation, to_approve) = self.validate_and_normalize_inputs(
            implementation, to_approve
        )
        tx_params = super().normalize_tx_params(tx_params)
        self._underlying_method(implementation, to_approve).call(
            tx_params.as_dict()
        )
    ...
    def send_transaction(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(implementation, to_approve).transact(
            tx_params.as_dict()
        )
    ...
    def estimate_gas(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(implementation, to_approve).estimateGas(
            tx_params.as_dict()
        )
...
class DeployProxyMethod(ContractMethod):  # pylint: disable=invalid-name
    ...
    def validate_and_normalize_inputs(
        self, _type: Union[bytes, str], data: Union[bytes, str]
    ):
    ...
    def call(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        returned = self._underlying_method(_type, data).call(
            tx_params.as_dict()
        )
        return str(returned)
    ...
    def send_transaction(
        ...
        (_type, data) = self.validate_and_normalize_inputs(_type, data)
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(_type, data).transact(
            tx_params.as_dict()
        )
    ...
    def build_transaction(
        ...
        (_type, data) = self.validate_and_normalize_inputs(_type, data)
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(_type, data).buildTransaction(
            tx_params.as_dict()
        )
    ...
    def estimate_gas(
        ...
        (_type, data) = self.validate_and_normalize_inputs(_type, data)
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(_type, data).estimateGas(
            tx_params.as_dict()
        )
...
class DeployProxyDeterministicMethod(
    ...
    def call(
        ...
        :returns: the return value of the underlying method.
        """
        (_type, data, salt) = self.validate_and_normalize_inputs(
            _type, data, salt
        )
        tx_params = super().normalize_tx_params(tx_params)
        returned = self._underlying_method(_type, data, salt).call(
            tx_params.as_dict()
        )
        return str(returned)
    ...
    def send_transaction(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(_type, data, salt).transact(
            tx_params.as_dict()
        )
    ...
    def build_transaction(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(_type, data, salt).buildTransaction(
            tx_params.as_dict()
        )
    ...
    def estimate_gas(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(_type, data, salt).estimateGas(
            tx_params.as_dict()
        )
...
class GetImplementationMethod(ContractMethod):  # pylint: disable=invalid-name
    ...
    def validate_and_normalize_inputs(
        self, _type: Union[bytes, str], version: int
    ):
    ...
    def call(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        returned = self._underlying_method(_type, version).call(
            tx_params.as_dict()
        )
        return str(returned)
    ...
    def send_transaction(
        ...
        (_type, version) = self.validate_and_normalize_inputs(_type, version)
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(_type, version).transact(
            tx_params.as_dict()
        )
    ...
    def build_transaction(
        ...
        (_type, version) = self.validate_and_normalize_inputs(_type, version)
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(_type, version).buildTransaction(
            tx_params.as_dict()
        )
    ...
    def estimate_gas(
        ...
        (_type, version) = self.validate_and_normalize_inputs(_type, version)
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(_type, version).estimateGas(
            tx_params.as_dict()
        )
...
class GetLatestImplementationMethod(
    ...
    def call(
        self, _type: Union[bytes, str], tx_params: Optional[TxParams] = None
    ) -> str:
        """Execute underlying contract method via eth_call.
    ...
    def build_transaction(
        ...
        (_type) = self.validate_and_normalize_inputs(_type)
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(_type).buildTransaction(
            tx_params.as_dict()
        )
...
class TWFactory:
    ...
    def __init__(
        ...
        functions = self._web3_eth.contract(
            address=to_checksum_address(contract_address), abi=TWFactory.abi()
        ).functions
        ...
        self.factory_role = FactoryRoleMethod(
            web3_or_provider, contract_address, functions.FACTORY_ROLE
        )

        self.add_implementation = AddImplementationMethod(
            web3_or_provider,
            contract_address,
            functions.addImplementation,
            validator,
        )

        self.approval = ApprovalMethod(
            web3_or_provider, contract_address, functions.approval, validator
        )

        self.approve_implementation = ApproveImplementationMethod(
            web3_or_provider,
            contract_address,
            functions.approveImplementation,
            validator,
        )

        self.current_version = CurrentVersionMethod(
            web3_or_provider,
            contract_address,
            functions.currentVersion,
            validator,
        )

        self.deploy_proxy = DeployProxyMethod(
            web3_or_provider,
            contract_address,
            functions.deployProxy,
            validator,
        )
        ...
        self.deploy_proxy_deterministic = DeployProxyDeterministicMethod(
            web3_or_provider,
            contract_address,
            functions.deployProxyDeterministic,
            validator,
        )

        self.deployer = DeployerMethod(
            web3_or_provider, contract_address, functions.deployer, validator
        )

        self.get_implementation = GetImplementationMethod(
            web3_or_provider,
            contract_address,
            functions.getImplementation,
            validator,
        )

        self.get_latest_implementation = GetLatestImplementationMethod(
            web3_or_provider,
            contract_address,
            functions.getLatestImplementation,
            validator,
        )
        ...
        self.registry = RegistryMethod(
            web3_or_provider, contract_address, functions.registry
        )
