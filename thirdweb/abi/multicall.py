...
try:
    ...
    class MulticallValidator(Validator):  # type: ignore
...
class Multicall:
    ...
    def __init__(
        ...
        if not validator:
            validator = MulticallValidator(web3_or_provider, contract_address)
        ...
        functions = self._web3_eth.contract(
            address=to_checksum_address(contract_address), abi=Multicall.abi()
        ).functions
