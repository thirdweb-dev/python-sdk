"""Generated wrapper for IDropERC1155 Solidity contract."""
...
# constructor for IDropERC1155 below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        IDropERC1155Validator,
    )
except ImportError:

    class IDropERC1155Validator(Validator):  # type: ignore
...
class IDropERC1155AllowlistProof(TypedDict):
    """Python representation of a tuple or struct.
...
class ClaimMethod(ContractMethod):  # pylint: disable=invalid-name
    ...
    def validate_and_normalize_inputs(
        ...
        currency: str,
        price_per_token: int,
        allowlist_proof: IDropERC1155AllowlistProof,
...
class IDropERC1155:
    """Wrapper class for IDropERC1155 Solidity contract.
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: IDropERC1155Validator = None,
    ):
        ...
        if not validator:
            validator = IDropERC1155Validator(
