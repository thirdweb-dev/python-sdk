"""Generated wrapper for PackVRFDirect Solidity contract."""
...
# constructor for PackVRFDirect below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        PackVRFDirectValidator,
    )
except ImportError:

    class PackVRFDirectValidator(Validator):  # type: ignore
...
class CreatePackMethod(ContractMethod):  # pylint: disable=invalid-name
    ...
    def validate_and_normalize_inputs(
        ...
        self.validator.assert_valid(
            method_name="createPack",
            parameter_name="_numOfRewardUnits",
            argument_value=num_of_reward_units,
        )
        self.validator.assert_valid(
            method_name="createPack",
            parameter_name="_packUri",
            argument_value=pack_uri,
        )
        self.validator.assert_valid(
            method_name="createPack",
            parameter_name="_openStartTimestamp",
            argument_value=open_start_timestamp,
        )
        self.validator.assert_valid(
            method_name="createPack",
            parameter_name="_amountDistributedPerOpen",
...
class GetPackContentsMethod(ContractMethod):  # pylint: disable=invalid-name
    """Various interfaces to the getPackContents method."""
    ...
    def validate_and_normalize_inputs(self, pack_id: int):
        """Validate the inputs to the getPackContents method."""
        self.validator.assert_valid(
            method_name="getPackContents",
    ...
    ) -> Tuple[List[ITokenBundleToken], List[int]]:
        """Execute underlying contract method via eth_call.
...
class RawFulfillRandomWordsMethod(
    ContractMethod
):  # pylint: disable=invalid-name
    """Various interfaces to the rawFulfillRandomWords method."""
    ...
    def validate_and_normalize_inputs(
        self, request_id: int, random_words: List[int]
    ):
        """Validate the inputs to the rawFulfillRandomWords method."""
        self.validator.assert_valid(
            method_name="rawFulfillRandomWords",
        ...
        self.validator.assert_valid(
            method_name="rawFulfillRandomWords",
            parameter_name="_randomWords",
            argument_value=random_words,
        )
        return (request_id, random_words)
    ...
    def call(
        ...
        :returns: the return value of the underlying method.
        """
        (request_id, random_words) = self.validate_and_normalize_inputs(
            request_id, random_words
        )
        tx_params = super().normalize_tx_params(tx_params)
        self._underlying_method(request_id, random_words).call(
            tx_params.as_dict()
        )
    ...
    def send_transaction(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(request_id, random_words).transact(
            tx_params.as_dict()
        )
    ...
    def estimate_gas(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(request_id, random_words).estimateGas(
            tx_params.as_dict()
        )
...
class SendRewardsIndirectMethod(
    ContractMethod
):  # pylint: disable=invalid-name
    """Various interfaces to the sendRewardsIndirect method."""
    ...
    def validate_and_normalize_inputs(self, opener: str):
        """Validate the inputs to the sendRewardsIndirect method."""
        self.validator.assert_valid(
            method_name="sendRewardsIndirect",
            parameter_name="_opener",
            argument_value=opener,
        )
        opener = self.validate_and_checksum_address(opener)
    ...
    def call(self, opener: str, tx_params: Optional[TxParams] = None) -> None:
        """Execute underlying contract method via eth_call.
        ...
        (opener) = self.validate_and_normalize_inputs(opener)
        tx_params = super().normalize_tx_params(tx_params)
        self._underlying_method(opener).call(tx_params.as_dict())
...
class PackVRFDirect:
    """Wrapper class for PackVRFDirect Solidity contract.
    ...
    get_pack_contents: GetPackContentsMethod
    """Constructor-initialized instance of
    :class:`GetPackContentsMethod`.
    """
    ...
    raw_fulfill_random_words: RawFulfillRandomWordsMethod
    """Constructor-initialized instance of
    :class:`RawFulfillRandomWordsMethod`.
    """
    ...
    send_rewards_indirect: SendRewardsIndirectMethod
    """Constructor-initialized instance of
    :class:`SendRewardsIndirectMethod`.
    """
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: PackVRFDirectValidator = None,
    ):
        ...
        if not validator:
            validator = PackVRFDirectValidator(
        ...
        self.get_pack_contents = GetPackContentsMethod(
            web3_or_provider,
            contract_address,
            functions.getPackContents,
            validator,
        )
        ...
        self.raw_fulfill_random_words = RawFulfillRandomWordsMethod(
            web3_or_provider,
            contract_address,
            functions.rawFulfillRandomWords,
            validator,
        )
        ...
        self.send_rewards_indirect = SendRewardsIndirectMethod(
            web3_or_provider,
            contract_address,
            functions.sendRewardsIndirect,
            validator,
        )
