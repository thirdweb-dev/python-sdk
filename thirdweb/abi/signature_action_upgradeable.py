"""Generated wrapper for SignatureActionUpgradeable Solidity contract."""
...
# constructor for SignatureActionUpgradeable below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        SignatureActionUpgradeableValidator,
    )
except ImportError:

    class SignatureActionUpgradeableValidator(Validator):  # type: ignore
...
class SignatureActionUpgradeable:
    """Wrapper class for SignatureActionUpgradeable Solidity contract.
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: SignatureActionUpgradeableValidator = None,
    ):
        ...
        if not validator:
            validator = SignatureActionUpgradeableValidator(
        ...
        functions = self._web3_eth.contract(
            ...
            abi=SignatureActionUpgradeable.abi(),
        ).functions
