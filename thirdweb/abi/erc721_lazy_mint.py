"""Generated wrapper for ERC721LazyMint Solidity contract."""
...
# constructor for ERC721LazyMint below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        ERC721LazyMintValidator,
    )
except ImportError:

    class ERC721LazyMintValidator(Validator):  # type: ignore
...
class ERC721LazyMint:
    """Wrapper class for ERC721LazyMint Solidity contract.
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: ERC721LazyMintValidator = None,
    ):
        ...
        if not validator:
            validator = ERC721LazyMintValidator(
