"""Generated wrapper for ERC1155Base Solidity contract."""
...
# constructor for ERC1155Base below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        ERC1155BaseValidator,
    )
except ImportError:

    class ERC1155BaseValidator(Validator):  # type: ignore
...
class ERC1155Base:
    """Wrapper class for ERC1155Base Solidity contract.
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: ERC1155BaseValidator = None,
    ):
        ...
        if not validator:
            validator = ERC1155BaseValidator(
