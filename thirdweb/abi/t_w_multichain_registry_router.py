"""Generated wrapper for TWMultichainRegistryRouter Solidity contract."""
...
# constructor for TWMultichainRegistryRouter below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        TWMultichainRegistryRouterValidator,
    )
except ImportError:

    class TWMultichainRegistryRouterValidator(Validator):  # type: ignore
...
class TWMultichainRegistryRouter:
    """Wrapper class for TWMultichainRegistryRouter Solidity contract."""
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: TWMultichainRegistryRouterValidator = None,
    ):
        ...
        if not validator:
            validator = TWMultichainRegistryRouterValidator(
        ...
        functions = self._web3_eth.contract(
            ...
            abi=TWMultichainRegistryRouter.abi(),
        ).functions
