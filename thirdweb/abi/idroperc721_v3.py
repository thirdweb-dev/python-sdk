"""Generated wrapper for IDropERC721_V3 Solidity contract."""
...
# constructor for IDropERC721_V3 below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        IDropERC721_V3Validator,
    )
except ImportError:

    class IDropERC721_V3Validator(Validator):  # type: ignore
...
class IDropERC721_V3:
    """Wrapper class for IDropERC721_V3 Solidity contract.
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: IDropERC721_V3Validator = None,
    ):
        ...
        if not validator:
            validator = IDropERC721_V3Validator(
