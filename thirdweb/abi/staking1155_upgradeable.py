"""Generated wrapper for Staking1155Upgradeable Solidity contract."""
...
# constructor for Staking1155Upgradeable below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        Staking1155UpgradeableValidator,
    )
except ImportError:

    class Staking1155UpgradeableValidator(Validator):  # type: ignore
...
class Staking1155Upgradeable:
    """Wrapper class for Staking1155Upgradeable Solidity contract."""
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: Staking1155UpgradeableValidator = None,
    ):
        ...
        if not validator:
            validator = Staking1155UpgradeableValidator(
        ...
        functions = self._web3_eth.contract(
            ...
            abi=Staking1155Upgradeable.abi(),
        ).functions
