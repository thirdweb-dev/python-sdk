"""Generated wrapper for IOperatorFilterToggle Solidity contract."""
...
# constructor for IOperatorFilterToggle below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        IOperatorFilterToggleValidator,
    )
except ImportError:

    class IOperatorFilterToggleValidator(Validator):  # type: ignore
...
class IOperatorFilterToggle:
    """Wrapper class for IOperatorFilterToggle Solidity contract."""
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: IOperatorFilterToggleValidator = None,
    ):
        ...
        if not validator:
            validator = IOperatorFilterToggleValidator(
    ...
    def abi():
        ...
        return json.loads(
            '[{"anonymous":false,"inputs":[{"indexed":false,"internalType":"bool","name":"restriction","type":"bool"}],"name":"OperatorRestriction","type":"event"},{"inputs":[],"name":"operatorRestriction","outputs":[{"internalType":"bool","name":"","type":"bool"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"bool","name":"restriction","type":"bool"}],"name":"setOperatorRestriction","outputs":[],"stateMutability":"nonpayable","type":"function"}]'  # noqa: E501 (line-too-long)
        )
