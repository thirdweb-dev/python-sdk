...
try:
    ...
    class SignatureMintERC721Validator(Validator):  # type: ignore
...
class MintWithSignatureMethod(ContractMethod):  # pylint: disable=invalid-name
    ...
    def validate_and_normalize_inputs(
        self,
        req: ISignatureMintERC721MintRequest,
...
class SignatureMintERC721:
    ...
    def __init__(
        ...
        if not validator:
            validator = SignatureMintERC721Validator(
