"""Generated wrapper for ERC20Vote Solidity contract."""
...
# constructor for ERC20Vote below.
try:
    ...
    class ERC20VoteValidator(Validator):  # type: ignore
...
class ERC20Vote:
    """Wrapper class for ERC20Vote Solidity contract."""
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: ERC20VoteValidator = None,
    ):
        ...
        if not validator:
            validator = ERC20VoteValidator(web3_or_provider, contract_address)
        ...
        functions = self._web3_eth.contract(
            address=to_checksum_address(contract_address), abi=ERC20Vote.abi()
        ).functions
