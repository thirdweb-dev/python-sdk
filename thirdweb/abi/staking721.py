"""Generated wrapper for Staking721 Solidity contract."""
...
# constructor for Staking721 below.
try:
    ...
    class Staking721Validator(Validator):  # type: ignore
...
class Staking721:
    """Wrapper class for Staking721 Solidity contract."""
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: Staking721Validator = None,
    ):
        ...
        if not validator:
            validator = Staking721Validator(web3_or_provider, contract_address)
        ...
        functions = self._web3_eth.contract(
            address=to_checksum_address(contract_address), abi=Staking721.abi()
        ).functions
