"""Generated wrapper for AirdropERC20 Solidity contract."""
...
# constructor for AirdropERC20 below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        AirdropERC20Validator,
    )
except ImportError:

    class AirdropERC20Validator(Validator):  # type: ignore
...
class AirdropERC20:
    """Wrapper class for AirdropERC20 Solidity contract."""
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: AirdropERC20Validator = None,
    ):
        ...
        if not validator:
            validator = AirdropERC20Validator(
