"""Generated wrapper for ContractMetadataLogic Solidity contract."""
...
# constructor for ContractMetadataLogic below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        ContractMetadataLogicValidator,
    )
except ImportError:

    class ContractMetadataLogicValidator(Validator):  # type: ignore
...
class ContractMetadataLogic:
    """Wrapper class for ContractMetadataLogic Solidity contract."""
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: ContractMetadataLogicValidator = None,
    ):
        ...
        if not validator:
            validator = ContractMetadataLogicValidator(
    ...
    def abi():
        ...
        return json.loads(
            '[{"anonymous":false,"inputs":[{"indexed":false,"internalType":"string","name":"prevURI","type":"string"},{"indexed":false,"internalType":"string","name":"newURI","type":"string"}],"name":"ContractURIUpdated","type":"event"},{"inputs":[],"name":"contractURI","outputs":[{"internalType":"string","name":"","type":"string"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"string","name":"_uri","type":"string"}],"name":"setContractURI","outputs":[],"stateMutability":"nonpayable","type":"function"}]'  # noqa: E501 (line-too-long)
        )
