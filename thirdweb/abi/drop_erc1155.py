...
class VerifyClaimMethod(ContractMethod): # pylint: disable=invalid-name
    ...
    def validate_and_normalize_inputs(self, condition_id: int, claimer: str, token_id: int, quantity: int, currency: str, price_per_token: int):
        ...
        # safeguard against fractional inputs
        price_per_token = int(price_per_token)
        return (condition_id, claimer, token_id, quantity, currency, price_per_token)

    def call(self, condition_id: int, claimer: str, token_id: int, quantity: int, currency: str, price_per_token: int, tx_params: Optional[TxParams] = None) -> None:
        """Execute underlying contract method via eth_call.

        :param tx_params: transaction parameters
        :returns: the return value of the underlying method.
        """
        (condition_id, claimer, token_id, quantity, currency, price_per_token) = self.validate_and_normalize_inputs(condition_id, claimer, token_id, quantity, currency, price_per_token)
        tx_params = super().normalize_tx_params(tx_params)
        self._underlying_method(condition_id, claimer, token_id, quantity, currency, price_per_token).call(tx_params.as_dict())

    def send_transaction(self, condition_id: int, claimer: str, token_id: int, quantity: int, currency: str, price_per_token: int, tx_params: Optional[TxParams] = None) -> Union[HexBytes, bytes]:
        """Execute underlying contract method via eth_sendTransaction.
        ...
        (condition_id, claimer, token_id, quantity, currency, price_per_token) = self.validate_and_normalize_inputs(condition_id, claimer, token_id, quantity, currency, price_per_token)
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(condition_id, claimer, token_id, quantity, currency, price_per_token).transact(tx_params.as_dict())

    def build_transaction(self, condition_id: int, claimer: str, token_id: int, quantity: int, currency: str, price_per_token: int, tx_params: Optional[TxParams] = None) -> dict:
        """Construct calldata to be used as input to the method."""
        (condition_id, claimer, token_id, quantity, currency, price_per_token) = self.validate_and_normalize_inputs(condition_id, claimer, token_id, quantity, currency, price_per_token)
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(condition_id, claimer, token_id, quantity, currency, price_per_token).buildTransaction(tx_params.as_dict())

    def estimate_gas(self, condition_id: int, claimer: str, token_id: int, quantity: int, currency: str, price_per_token: int, tx_params: Optional[TxParams] = None) -> int:
        """Estimate gas consumption of method call."""
        (condition_id, claimer, token_id, quantity, currency, price_per_token) = self.validate_and_normalize_inputs(condition_id, claimer, token_id, quantity, currency, price_per_token)
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(condition_id, claimer, token_id, quantity, currency, price_per_token).estimateGas(tx_params.as_dict())
