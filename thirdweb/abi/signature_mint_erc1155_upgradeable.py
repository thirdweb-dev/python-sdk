"""Generated wrapper for SignatureMintERC1155Upgradeable Solidity contract."""
...
# constructor for SignatureMintERC1155Upgradeable below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        SignatureMintERC1155UpgradeableValidator,
    )
except ImportError:

    class SignatureMintERC1155UpgradeableValidator(Validator):  # type: ignore
...
class SignatureMintERC1155Upgradeable:
    """Wrapper class for SignatureMintERC1155Upgradeable Solidity contract.
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: SignatureMintERC1155UpgradeableValidator = None,
    ):
        ...
        if not validator:
            validator = SignatureMintERC1155UpgradeableValidator(
        ...
        functions = self._web3_eth.contract(
            ...
            abi=SignatureMintERC1155Upgradeable.abi(),
        ).functions
