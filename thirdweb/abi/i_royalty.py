"""Generated wrapper for IRoyalty Solidity contract."""
...
# constructor for IRoyalty below.
try:
    ...
    class IRoyaltyValidator(  # type: ignore
        Validator
    ):
...
class IRoyalty:
    """Wrapper class for IRoyalty Solidity contract."""
    ...
    def __init__(
        ...
        validator: IRoyaltyValidator = None,
    ):
        ...
        if not validator:
            validator = IRoyaltyValidator(web3_or_provider, contract_address)
        ...
        functions = self._web3_eth.contract(address=to_checksum_address(contract_address), abi=IRoyalty.abi()).functions
    ...
    def get_default_royalty_event(
        ...
        return self._web3_eth.contract(address=to_checksum_address(self.contract_address), abi=IRoyalty.abi()).events.DefaultRoyalty().processReceipt(tx_receipt)
    def get_royalty_for_token_event(
        ...
        """
        tx_receipt = self._web3_eth.getTransactionReceipt(tx_hash)
        return self._web3_eth.contract(address=to_checksum_address(self.contract_address), abi=IRoyalty.abi()).events.RoyaltyForToken().processReceipt(tx_receipt)
