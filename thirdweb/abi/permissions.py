"""Generated wrapper for Permissions Solidity contract."""
...
# constructor for Permissions below.
try:
    ...
    class PermissionsValidator(Validator):  # type: ignore
...
class Permissions:
    """Wrapper class for Permissions Solidity contract."""
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: PermissionsValidator = None,
    ):
