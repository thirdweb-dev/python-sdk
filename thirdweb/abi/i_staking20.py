"""Generated wrapper for IStaking20 Solidity contract."""
...
# constructor for IStaking20 below.
try:
    ...
    class IStaking20Validator(Validator):  # type: ignore
...
class IStaking20:
    """Wrapper class for IStaking20 Solidity contract."""
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: IStaking20Validator = None,
    ):
        ...
        if not validator:
            validator = IStaking20Validator(web3_or_provider, contract_address)
        ...
        functions = self._web3_eth.contract(
            address=to_checksum_address(contract_address), abi=IStaking20.abi()
        ).functions
