"""Generated wrapper for ERC1155PresetUpgradeable Solidity contract."""
...
# constructor for ERC1155PresetUpgradeable below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        ERC1155PresetUpgradeableValidator,
    )
except ImportError:

    class ERC1155PresetUpgradeableValidator(Validator):  # type: ignore
...
class ERC1155PresetUpgradeable:
    """Wrapper class for ERC1155PresetUpgradeable Solidity contract.
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: ERC1155PresetUpgradeableValidator = None,
    ):
        ...
        if not validator:
            validator = ERC1155PresetUpgradeableValidator(
        ...
        functions = self._web3_eth.contract(
            ...
            abi=ERC1155PresetUpgradeable.abi(),
        ).functions
