"""Generated wrapper for ISignatureMintERC1155 Solidity contract."""
...
# constructor for ISignatureMintERC1155 below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        ISignatureMintERC1155Validator,
    )
except ImportError:

    class ISignatureMintERC1155Validator(Validator):  # type: ignore
...
class ISignatureMintERC1155:
    """Wrapper class for ISignatureMintERC1155 Solidity contract.
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: ISignatureMintERC1155Validator = None,
    ):
        ...
        if not validator:
            validator = ISignatureMintERC1155Validator(
