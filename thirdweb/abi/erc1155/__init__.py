...
class UriMethod(ContractMethod):  # pylint: disable=invalid-name
    ...
    def validate_and_normalize_inputs(self, index_0: int):
        ...
        self.validator.assert_valid(
            method_name="uri", parameter_name="index_0", argument_value=index_0,
        )
        # safeguard against fractional inputs
        index_0 = int(index_0)
        return index_0
...
class ERC1155:
    ...
    def __init__(
        ...
        functions = self._web3_eth.contract(
            address=to_checksum_address(contract_address), abi=ERC1155.abi()
        ).functions
    ...
    def get_approval_for_all_event(
        ...
        return (
            self._web3_eth.contract(
                address=to_checksum_address(self.contract_address), abi=ERC1155.abi()
            )
