"""Generated wrapper for OperatorFilterToggle Solidity contract."""
...
# constructor for OperatorFilterToggle below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        OperatorFilterToggleValidator,
    )
except ImportError:

    class OperatorFilterToggleValidator(Validator):  # type: ignore
...
class OperatorFilterToggle:
    """Wrapper class for OperatorFilterToggle Solidity contract."""
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: OperatorFilterToggleValidator = None,
    ):
        ...
        if not validator:
            validator = OperatorFilterToggleValidator(
