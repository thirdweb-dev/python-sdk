"""Generated wrapper for AirdropERC721Claimable Solidity contract."""
...
# constructor for AirdropERC721Claimable below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        AirdropERC721ClaimableValidator,
    )
except ImportError:

    class AirdropERC721ClaimableValidator(Validator):  # type: ignore
...
class NextIndexMethod(ContractMethod):  # pylint: disable=invalid-name
    """Various interfaces to the nextIndex method."""
...
class TokenIdsMethod(ContractMethod):  # pylint: disable=invalid-name
    """Various interfaces to the tokenIds method."""
    ...
    def validate_and_normalize_inputs(self, index_0: int):
        """Validate the inputs to the tokenIds method."""
        self.validator.assert_valid(
            method_name="tokenIds",
            parameter_name="index_0",
            argument_value=index_0,
        )
        # safeguard against fractional inputs
...
class AirdropERC721Claimable:
    """Wrapper class for AirdropERC721Claimable Solidity contract."""
    ...
    next_index: NextIndexMethod
    """Constructor-initialized instance of
    :class:`NextIndexMethod`.
    """
    ...
    token_ids: TokenIdsMethod
    """Constructor-initialized instance of
    :class:`TokenIdsMethod`.
    """
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: AirdropERC721ClaimableValidator = None,
    ):
        ...
        if not validator:
            validator = AirdropERC721ClaimableValidator(
        ...
        functions = self._web3_eth.contract(
            ...
            abi=AirdropERC721Claimable.abi(),
        ).functions
        ...
        self.next_index = NextIndexMethod(
            web3_or_provider, contract_address, functions.nextIndex
        )
        ...
        self.token_ids = TokenIdsMethod(
            web3_or_provider, contract_address, functions.tokenIds, validator
        )
