"""Generated wrapper for PermissionsLogic Solidity contract."""
...
# constructor for PermissionsLogic below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        PermissionsLogicValidator,
    )
except ImportError:

    class PermissionsLogicValidator(Validator):  # type: ignore
...
class PermissionsLogic:
    """Wrapper class for PermissionsLogic Solidity contract."""
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: PermissionsLogicValidator = None,
    ):
        ...
        if not validator:
            validator = PermissionsLogicValidator(
