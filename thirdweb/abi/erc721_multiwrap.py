"""Generated wrapper for ERC721Multiwrap Solidity contract."""
...
# constructor for ERC721Multiwrap below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        ERC721MultiwrapValidator,
    )
except ImportError:

    class ERC721MultiwrapValidator(Validator):  # type: ignore
...
class WrapMethod(ContractMethod):  # pylint: disable=invalid-name
    ...
    def validate_and_normalize_inputs(
        self,
        tokens_to_wrap: List[ITokenBundleToken],
...
class ERC721Multiwrap:
    """Wrapper class for ERC721Multiwrap Solidity contract.
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: ERC721MultiwrapValidator = None,
    ):
        ...
        if not validator:
            validator = ERC721MultiwrapValidator(
