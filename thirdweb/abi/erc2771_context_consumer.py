"""Generated wrapper for ERC2771ContextConsumer Solidity contract."""
...
# constructor for ERC2771ContextConsumer below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        ERC2771ContextConsumerValidator,
    )
except ImportError:

    class ERC2771ContextConsumerValidator(Validator):  # type: ignore
...
class ERC2771ContextConsumer:
    """Wrapper class for ERC2771ContextConsumer Solidity contract."""
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: ERC2771ContextConsumerValidator = None,
    ):
        ...
        if not validator:
            validator = ERC2771ContextConsumerValidator(
        ...
        functions = self._web3_eth.contract(
            ...
            abi=ERC2771ContextConsumer.abi(),
        ).functions
