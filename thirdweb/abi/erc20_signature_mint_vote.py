"""Generated wrapper for ERC20SignatureMintVote Solidity contract."""
...
# constructor for ERC20SignatureMintVote below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        ERC20SignatureMintVoteValidator,
    )
except ImportError:

    class ERC20SignatureMintVoteValidator(Validator):  # type: ignore
...
class ERC20SignatureMintVote:
    """Wrapper class for ERC20SignatureMintVote Solidity contract.
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: ERC20SignatureMintVoteValidator = None,
    ):
        ...
        if not validator:
            validator = ERC20SignatureMintVoteValidator(
        ...
        functions = self._web3_eth.contract(
            ...
            abi=ERC20SignatureMintVote.abi(),
        ).functions
