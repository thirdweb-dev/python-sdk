"""Generated wrapper for IDropSinglePhase1155_V1 Solidity contract."""
...
# constructor for IDropSinglePhase1155_V1 below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        IDropSinglePhase1155_V1Validator,
    )
except ImportError:

    class IDropSinglePhase1155_V1Validator(Validator):  # type: ignore
...
class IDropSinglePhase1155_V1:
    """Wrapper class for IDropSinglePhase1155_V1 Solidity contract.
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: IDropSinglePhase1155_V1Validator = None,
    ):
        ...
        if not validator:
            validator = IDropSinglePhase1155_V1Validator(
        ...
        functions = self._web3_eth.contract(
            ...
            abi=IDropSinglePhase1155_V1.abi(),
        ).functions
