"""Generated wrapper for PlatformFee Solidity contract."""
...
# constructor for PlatformFee below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        PlatformFeeValidator,
    )
except ImportError:

    class PlatformFeeValidator(Validator):  # type: ignore
...
class PlatformFee:
    """Wrapper class for PlatformFee Solidity contract."""
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: PlatformFeeValidator = None,
    ):
        ...
        if not validator:
            validator = PlatformFeeValidator(
