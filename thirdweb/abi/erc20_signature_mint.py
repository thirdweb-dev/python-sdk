"""Generated wrapper for ERC20SignatureMint Solidity contract."""
...
# constructor for ERC20SignatureMint below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        ERC20SignatureMintValidator,
    )
except ImportError:

    class ERC20SignatureMintValidator(Validator):  # type: ignore
...
class ERC20SignatureMint:
    """Wrapper class for ERC20SignatureMint Solidity contract.
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: ERC20SignatureMintValidator = None,
    ):
        ...
        if not validator:
            validator = ERC20SignatureMintValidator(
