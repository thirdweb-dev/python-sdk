"""Generated wrapper for ERC1155LazyMint Solidity contract."""
...
# constructor for ERC1155LazyMint below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        ERC1155LazyMintValidator,
    )
except ImportError:

    class ERC1155LazyMintValidator(Validator):  # type: ignore
...
class ERC1155LazyMint:
    """Wrapper class for ERC1155LazyMint Solidity contract.
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: ERC1155LazyMintValidator = None,
    ):
        ...
        if not validator:
            validator = ERC1155LazyMintValidator(
