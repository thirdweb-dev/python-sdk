"""Generated wrapper for IERC2771Context Solidity contract."""
...
# constructor for IERC2771Context below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        IERC2771ContextValidator,
    )
except ImportError:

    class IERC2771ContextValidator(Validator):  # type: ignore
...
class IERC2771Context:
    """Wrapper class for IERC2771Context Solidity contract."""
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: IERC2771ContextValidator = None,
    ):
        ...
        if not validator:
            validator = IERC2771ContextValidator(
