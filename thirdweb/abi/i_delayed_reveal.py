"""Generated wrapper for IDelayedReveal Solidity contract."""
...
# constructor for IDelayedReveal below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        IDelayedRevealValidator,
    )
except ImportError:

    class IDelayedRevealValidator(Validator):  # type: ignore
...
class IDelayedReveal:
    """Wrapper class for IDelayedReveal Solidity contract.
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: IDelayedRevealValidator = None,
    ):
        ...
        if not validator:
            validator = IDelayedRevealValidator(
