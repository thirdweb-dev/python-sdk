"""Generated wrapper for ERC2771ContextUpgradeableLogic Solidity contract."""
...
# constructor for ERC2771ContextUpgradeableLogic below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        ERC2771ContextUpgradeableLogicValidator,
    )
except ImportError:

    class ERC2771ContextUpgradeableLogicValidator(Validator):  # type: ignore
...
class ERC2771ContextUpgradeableLogic:
    """Wrapper class for ERC2771ContextUpgradeableLogic Solidity contract."""
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: ERC2771ContextUpgradeableLogicValidator = None,
    ):
        ...
        if not validator:
            validator = ERC2771ContextUpgradeableLogicValidator(
        ...
        functions = self._web3_eth.contract(
            ...
            abi=ERC2771ContextUpgradeableLogic.abi(),
        ).functions
