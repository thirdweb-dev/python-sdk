"""Generated wrapper for DropSinglePhase Solidity contract."""
...
# constructor for DropSinglePhase below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        DropSinglePhaseValidator,
    )
except ImportError:

    class DropSinglePhaseValidator(Validator):  # type: ignore
...
class DropSinglePhase:
    """Wrapper class for DropSinglePhase Solidity contract.
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: DropSinglePhaseValidator = None,
    ):
        ...
        if not validator:
            validator = DropSinglePhaseValidator(
