"""Generated wrapper for IERC721A Solidity contract."""
...
# constructor for IERC721A below.
try:
    ...
    class IERC721AValidator(Validator):  # type: ignore
...
class IERC721A:
    """Wrapper class for IERC721A Solidity contract.
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: IERC721AValidator = None,
    ):
        ...
        if not validator:
            validator = IERC721AValidator(web3_or_provider, contract_address)
        ...
        functions = self._web3_eth.contract(
            address=to_checksum_address(contract_address), abi=IERC721A.abi()
        ).functions
