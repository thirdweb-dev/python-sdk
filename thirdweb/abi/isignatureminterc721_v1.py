"""Generated wrapper for ISignatureMintERC721_V1 Solidity contract."""
...
# constructor for ISignatureMintERC721_V1 below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        ISignatureMintERC721_V1Validator,
    )
except ImportError:

    class ISignatureMintERC721_V1Validator(Validator):  # type: ignore
...
class ISignatureMintERC721_V1:
    """Wrapper class for ISignatureMintERC721_V1 Solidity contract.
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: ISignatureMintERC721_V1Validator = None,
    ):
        ...
        if not validator:
            validator = ISignatureMintERC721_V1Validator(
        ...
        functions = self._web3_eth.contract(
            ...
            abi=ISignatureMintERC721_V1.abi(),
        ).functions
