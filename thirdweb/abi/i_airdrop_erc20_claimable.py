"""Generated wrapper for IAirdropERC20Claimable Solidity contract."""
...
# constructor for IAirdropERC20Claimable below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        IAirdropERC20ClaimableValidator,
    )
except ImportError:

    class IAirdropERC20ClaimableValidator(Validator):  # type: ignore
...
class IAirdropERC20Claimable:
    """Wrapper class for IAirdropERC20Claimable Solidity contract."""
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: IAirdropERC20ClaimableValidator = None,
    ):
        ...
        if not validator:
            validator = IAirdropERC20ClaimableValidator(
        ...
        functions = self._web3_eth.contract(
            ...
            abi=IAirdropERC20Claimable.abi(),
        ).functions
